# Requirements Archive — Heimdall (through v1.1)

> **ARCHIVED 2026-06-20 at v1.1 milestone close.** This is a point-in-time snapshot of `.planning/REQUIREMENTS.md` as it stood when milestone v1.1 (LinkedIn Scraping by Company, Phases 7–10) shipped. It contains the full requirement history accumulated across the v1.0 (Phases 1–6) and v1.1 (Phases 7–10) cycles plus the v2 deferred backlog, since neither cycle maintained a separate requirements file. The v1.1 requirements (JL-C1..JL-C9, ENR-01..ENR-06) are marked complete below with outcomes. A fresh `REQUIREMENTS.md` is created for the next milestone via `/gsd:new-milestone`.

# Requirements: Heimdall

**Defined:** 2026-05-12
**Archived:** 2026-06-20 (v1.1)
...
## v1.1 Active — Connection Company + Role Enrichment for Triage (Phase 10)

> Added 2026-05-20 mid-milestone. These requirements were tracked in the ROADMAP Phase 10 detail rather than in this file during the cycle; they are recorded here at archive time for completeness. All shipped in Phase 10 (4 plans, completed 2026-05-20).

- [x] **ENR-01**: At-connection schema fields (`companyAtConnection`, `roleAtConnection`, `enrichmentStatus`, `enrichedAt`) on `contacts` + a sweep index for the batch backlog. Shipped: migration 0010 + `contact_enrichment_status` enum (Plan 10-01).
- [x] **ENR-02**: CSV import seeds the at-connection baseline (`companyAtConnection`/`roleAtConnection`) without disturbing the dedup path. Shipped: import seeding (Plan 10-02).
- [x] **ENR-03**: REST write-back endpoint + skill per-profile scrape mode. Shipped: `PATCH /api/contacts/[id]/enrichment` + `scrape-linkedin-connections` per-profile enrichment mode (Plans 10-02, 10-04).
- [x] **ENR-04**: Paced batch-sweep + documented anti-bot pacing strategy for a 1000+ profile backlog. Shipped: `GET /api/contacts/enrichment-queue` + paced batch-sweep mode + pacing/back-off docs in the skill references (Plans 10-02, 10-04).
- [x] **ENR-05**: Just-in-time enrichment on the company-triage path (no inline DB write). Shipped: JIT detection in the recommendations route (Plan 10-03).
- [x] **ENR-06**: Triage view renders company + role-at-connection. Shipped: recommendation-card render of at-connection company/role (Plan 10-03).
...
> Phase mapping populated by `gsd-roadmapper` on 2026-05-12. v1.1 rows added 2026-05-19. Statuses reconciled to actual completion at v1.1 archive (2026-06-20) — stale "Pending" rows for shipped phases were corrected to "Complete".

| Requirement | Phase | Milestone | Status |
|-------------|-------|-----------|--------|
| BUG-01 | Phase 1 | v1.0 | Complete |
| BUG-02 | Phase 1 | v1.0 | Complete |
| TEST-A1 | Phase 2 | v1.0 | Complete |
| TEST-A2 | Phase 2 | v1.0 | Complete |
| TEST-A3 | Phase 2 | v1.0 | Complete |
| SEC-A1 | Phase 3 | v1.0 | Complete |
| SEC-A2 | Phase 3 | v1.0 | Complete |
| DEBT-A1 | Phase 4 | v1.0 | Complete |
| DEBT-A2 | Phase 4 | v1.0 | Complete |
| DEBT-A3 | Phase 4 | v1.0 | Complete |
| DEBT-A4 | Phase 4 | v1.0 | Complete |
| DEBT-A5 | Phase 4 | v1.0 | Complete |
| JL-A1 | Phase 5 | v1.0 | SUPERSEDED |
| JL-A2 | Phase 5 | v1.0 | SUPERSEDED |
| JL-A3 | Phase 5 | v1.0 | SUPERSEDED |
| JL-A4 | Phase 5 | v1.0 | SUPERSEDED |
| JL-A5 | Phase 5 | v1.0 | SUPERSEDED |
| JL-B1 | Phase 5 | v1.0 | Complete |
| JL-B2 | Phase 5 | v1.0 | Complete |
| JL-B3 | Phase 5 | v1.0 | Complete |
| JL-B4 | Phase 5 | v1.0 | Complete |
| JL-B5 | Phase 5 | v1.0 | Complete |
| PERF-A1 | Phase 6 | v1.0 | Complete |
| PERF-A2 | Phase 6 | v1.0 | Complete |
| PERF-A3 | Phase 6 | v1.0 | Complete |
| PERF-A4 | Phase 6 | v1.0 | Complete |
| PERF-A5 | Phase 6 | v1.0 | Complete |
| JL-C3 | Phase 7 | v1.1 | Complete |
| JL-C4 | Phase 7 | v1.1 | Complete |
| JL-C1 | Phase 8 | v1.1 | Complete |
| JL-C2 | Phase 8 | v1.1 | Complete |
| JL-C5 | Phase 8 | v1.1 | Complete |
| JL-C6 | Phase 8 | v1.1 | Complete |
| JL-C7 | Phase 8 | v1.1 | Complete |
| JL-C8 | Phase 9 | v1.1 | Complete |
| JL-C9 | Phase 9 | v1.1 | Complete |
| ENR-01 | Phase 10 | v1.1 | Complete |
| ENR-02 | Phase 10 | v1.1 | Complete |
| ENR-03 | Phase 10 | v1.1 | Complete |
| ENR-04 | Phase 10 | v1.1 | Complete |
| ENR-05 | Phase 10 | v1.1 | Complete |
| ENR-06 | Phase 10 | v1.1 | Complete |

**Coverage:**
- v1.0 requirements (Phases 1–6): 27 mapped (5 JL-A superseded by JL-B1..B5) — all Complete
- v1.1 requirements (Phases 7–10): 15 total — JL-C1..JL-C9 (LinkedIn Scraping by Company) + ENR-01..ENR-06 (at-connection enrichment) — all Complete
- Mapped to phases: 42 ✓ (excluding superseded)
- Unmapped: 0 ✓

---
*Requirements defined: 2026-05-12*
*Archived: 2026-06-20 at v1.1 milestone close. v1.1 shipped JL-C1..JL-C9 (LinkedIn Scraping by Company, Phases 7–9) + ENR-01..ENR-06 (at-connection enrichment, Phase 10). v1.0 (Phases 1–6) shipped earlier; statuses reconciled at archive.*
